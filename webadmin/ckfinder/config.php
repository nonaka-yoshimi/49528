...
session_start();
$ckeditor_media_basepath = isset($_SESSION['ckeditor_media_basepath']) ? $_SESSION['ckeditor_media_basepath'] : "";
$ckeditor_media_dirpath = isset($_SESSION['ckeditor_media_dirpath']) ? $_SESSION['ckeditor_media_dirpath'] : "";
$ckeditor_media_thumbs_path = isset($_SESSION['ckeditor_media_thumbs_path']) ? $_SESSION['ckeditor_media_thumbs_path'] : "";
...
$config['Thumbnails'] = Array(
		'url' => $baseUrl . Config::ADMIN_DIR_PATH.'ckfinder/_thumbs',
		'directory' => $baseDir . Config::ADMIN_DIR_PATH.'/ckfinder/_thumbs',
		'enabled' => true,
		'directAccess' => false,
		'maxWidth' => 100,
		'maxHeight' => 100,
...
$config['ResourceType'][] = Array(
		...
		'url' => $baseUrl . $ckeditor_media_dirpath,
		'directory' => $baseDir ."",
		'maxSize' => 0,
...
$config['ResourceType'][] = Array(
		...
		'directory' => $baseDir . "",
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,pdf,png,svg,',
		'deniedExtensions' => '');
