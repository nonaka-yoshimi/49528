...
//権限取得
$ope_auth_publish = $session->user["ope_auth_parts_publish"];
$ope_auth_edit = $session->user["ope_auth_parts_edit"];
$ope_auth_delete = $session->user["ope_auth_parts_delete"];
...
<?php endif; ?>
<?php if($session->user["admintype"] == SPConst::ADMINTYPE_SUPERVISOR || $session->user["ope_auth_parts_add"]): ?>
