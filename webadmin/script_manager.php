...
//権限取得
$ope_auth_publish = $session->user["ope_auth_script_publish"];
$ope_auth_edit = $session->user["ope_auth_script_edit"];
$ope_auth_delete = $session->user["ope_auth_script_delete"];
...
$LayoutManager->setTitle("スクリプト管理");
...
<?php endif; ?>
<?php if($session->user["admintype"] == SPConst::ADMINTYPE_SUPERVISOR || $session->user["ope_auth_script_add"]): ?>
